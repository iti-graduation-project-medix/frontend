...
export default function DealDetails() {
  ...
  if (error) {
    return (
      <div className="flex justify-center items-center min-h-[60vh] bg-gray-50 dark:bg-background">
  ...
  if (!deal) {
    return (
      <div className="flex items-center justify-center min-h-[300px] text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-background">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-background py-4 sm:py-6 lg:py-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <Card className="shadow-sm border border-gray-200 dark:border-border bg-white dark:bg-card">
              <CardHeader className="bg-gradient-to-r from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 p-4 sm:p-6">
                <CardTitle className="flex items-center gap-3">
                  <div className="p-2 rounded-lg bg-blue-100 dark:bg-primary/20">
                    <Pill className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600 dark:text-primary" />
                  </div>
                  <div>
                  ...
                  <div className="flex items-center gap-2 ml-4">
                    <motion.button
                      ...
                      className={`p-2 rounded-full bg-gray-100 dark:bg-card hover:bg-gray-200 dark:hover:bg-muted/10 transition-colors ${
                        favLoading || isOwner
              ...
              <CardContent className="mb-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-foreground flex items-center gap-2">
                      <Info className="w-4 h-4 sm:w-5 sm:h-5 text-primary" />
                      <span className="sm:inline">Medicine Information</span>
                    </h3>
                    <div className="space-y-2 sm:space-y-3">
                      <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                      ...
                      <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                        <div className="flex items-center gap-2 sm:gap-3">
                          <Banknote className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 dark:text-green-400" />
                          <span className="font-medium text-gray-700 dark:text-gray-300 text-sm sm:text-base">
                            Price
                          </span>
                        </div>
                      ...
                      <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                        <div className="flex items-center gap-2 sm:gap-3">
                          <CalendarX className="w-4 h-4 sm:w-5 sm:h-5 text-orange-600 dark:text-orange-400" />
                          <span className="font-medium text-gray-700 dark:text-gray-300 text-sm sm:text-base">
                            Expiry
                          </span>
                        </div>
                        <span className="font-medium text-gray-900 dark:text-foreground text-sm sm:text-base">
                          {new Date(deal.expiryDate).toLocaleDateString()}
                        </span>
                      </div>
                      <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                        <div className="flex items-center gap-2 sm:gap-3">
                          <BoxIcon className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 dark:text-primary" />
                          <span className="font-medium text-gray-700 dark:text-gray-300 text-sm sm:text-base">
                            Box Status
                          </span>
                        </div>
                        <Badge
                          ...
                          className={`font-medium text-xs ${
                            deal.boxStatus === "damaged"
                              ? "bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400 border-red-200 dark:border-red-900"
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                        <div className="flex items-center gap-2 sm:gap-3">
                          <Pill className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-600 dark:text-indigo-400" />
                          <span className="font-medium text-gray-700 dark:text-gray-300 text-sm sm:text-base">
                            Form
                          </span>
                        </div>
            ...
            <Card className="shadow-sm border border-gray-200 dark:border-border bg-white dark:bg-card">
              <CardHeader className="bg-gradient-to-r from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <CardTitle className="flex items-center gap-3">
                  <div className="p-2 rounded-lg bg-blue-100 dark:bg-primary/20">
                  ...
                  <div className="flex items-center gap-2 ml-auto">
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-white dark:bg-background hover:bg-gray-50 dark:hover:bg-muted/10 text-gray-700 dark:text-foreground font-semibold px-3 py-2 rounded-lg shadow-sm transition-all text-xs border border-gray-200 dark:border-border hover:shadow-md"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 bg-primary hover:bg-primary-hover dark:bg-primary dark:hover:bg-primary-hover text-white font-semibold px-3 py-2 rounded-lg shadow-sm transition-all text-xs"
                    >
              ...
              <CardContent className="mb-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-semibold text-gray-900 dark:text-foreground text-sm sm:text-base truncate">
                          {deal.pharmacy.name}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                      <ShieldCheck className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 dark:text-green-400 mb-5" />
                      <div className="flex-1 min-w-0">
                        <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block">
                          License #
                        </span>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                      <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 dark:text-purple-400 mb-5" />
                      <div className="flex-1 min-w-0">
                        <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block">
                          Phone
                        </span>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                      <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-orange-600 dark:text-orange-400 mb-5" />
                      <div className="flex-1 min-w-0">
                        <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block">
                          Hours
                        </span>
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                      <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mb-5" />
                      <div className="flex-1 min-w-0">
                        <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block">
                          Address
                        </span>
                        <p className="font-semibold text-gray-900 dark:text-foreground text-xs sm:text-sm leading-relaxed">
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:gap-3">
                      <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                        <Building2 className="w-3 h-3 sm:w-4 sm:h-4 text-indigo-600 dark:text-indigo-400 mb-5" />
                        <div className="flex-1 min-w-0">
                          <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block">
                            City
                          </span>
                          <p className="font-semibold text-gray-900 dark:text-foreground text-xs sm:text-sm truncate">
                            {deal.pharmacy.city}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                        <Globe className="w-3 h-3 sm:w-4 sm:h-4 text-teal-600 dark:text-teal-400 mb-5" />
                        <div className="flex-1 min-w-0">
                          <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block">
                            Governorate
                          </span>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg border border-gray-200 dark:border-border bg-gray-50 dark:bg-background">
                      <Map className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 dark:text-gray-400 mb-5" />
                      <div className="flex-1 min-w-0">
                        <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block">
                          Zip Code
                        </span>
                ...
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4">
                    ...
                    <div className="relative">
                      <Avatar className="size-16 sm:size-20 shadow-md border-2 border-white dark:border-background">
                        {deal.postedBy.profilePhotoUrl ? (
                          ...
                          <AvatarFallback className="bg-gradient-to-br from-primary to-primary-hover dark:from-primary dark:to-primary-hover text-white text-sm sm:text-lg font-bold">
                            {initials}
                          </AvatarFallback>
                        )}
                      </Avatar>
                    ...
                    <div className="w-full space-y-2 sm:space-y-3">
                      ...
                      <Button
                        ...
                        variant="outline"
                        className="w-full border border-primary text-primary dark:text-primary hover:bg-primary/5 dark:hover:bg-primary/10 font-semibold px-4 sm:px-6 py-2 sm:py-3 rounded-lg shadow-sm transition-all text-xs sm:text-base flex items-center justify-center gap-2"
