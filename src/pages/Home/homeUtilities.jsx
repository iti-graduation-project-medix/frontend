...
,
    ...
    title: "Post Deals",
      description: "List medications you want to sell/exchange or post specific requests for stock you need."
    },
    {
      number: '03',
      icon: <Award />,
 ...
 title: "Receive Offers",
  ...
  export const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes, we offer emergency dental care during our regular business hours. Please call us immediately if you have a dental emergency, and we will do our best to see you as soon as possible.',
    },
    {
      question: 'Online live support',
      answer: 'Our online live support is available 24/7 to answer your questions, assist with appointments, and provide information. Look for the chat icon on our website to connect with a representative.',
    },
    {
  ...
  export const faqItems = [
    ...
    },
    {
      ...
      answer: "We ensure affordable treatment with full-time pharmacy support and transparent pricing.",
    },
  ];
  ...
  export const whyChooseUsFeatures = [
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-white">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.016-.098 2.007-.294 2.96L21 12zM3 12c0-1.016.098-2.007.294-2.96L3 12zM12 2.25c-5.32 0-9.753 3.42-10.96 8.16C.767 12.19 1.156 12 1.5 12c.5 0 .973.064 1.42.188A3.75 3.75 0 005.25 12h13.5a3.75 3.75 0 003.707-3.812C21.753 5.67 17.32 2.25 12 2.25z" />
        </svg>
      ),
      title: 'Certified Professionals',
      description: 'Our team comprises highly qualified and experienced experts dedicated to providing top-notch services.',
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-white">
      ...
      description: 'We prioritize your needs, offering personalized solutions and dedicated support to ensure your complete satisfaction.',
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-white">
          <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.75c0 .666-.318 1.31-.859 1.748l-4.577 3.05a1.2 1.2 0 01-1.348 0l-4.577-3.05A1.5 1.5 0 014.5 18.75V8.25a.75.75 0 011.5 0v10.5h12v-10.5a.75.75 0 011.5 0v10.5z" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 12c-2.4 0-4.332-1.89-4.332-4.25S9.6 3.5 12 3.5c2.4 0 4.332 1.89 4.332 4.25S14.4 12 12 12z" />
        </svg>
      ),
      title: 'Collaborative Approach',
      description: 'We work closely with clients, fostering open communication and partnership to achieve shared goals effectively.',
    },
  ];
