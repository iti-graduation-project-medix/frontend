...
export default function ResetPassword() {
  ...
  return (
    <div className="flex lg:my-30 md:my-10 flex-col items-center justify-center gap-6 p-6 md:p-10">
      <Card
        className="relative w-full max-w-md overflow-hidden shadow-2xl border-0 rounded-3xl  bg-gradient-to-br from-blue-50 via-white to-indigo-50"
            ...
            {({
              ...
              <Form className="flex flex-col gap-7">
                <div className="flex flex-col items-center gap-2 -mt-10">
                  ...
                  />
                  <h1 className="text-2xl font-bold tracking-tight text-primary/95">
                    Reset Password
                  </h1>
                  <p
