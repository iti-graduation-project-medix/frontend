  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Dawaback connects pharmacists to exchange surplus or near-expiry medicines, chat directly about each deal, and list pharmacies for sale. Secure, trusted, and built for the pharmacy community."
        />
        <meta
          name="keywords"
          content="pharmacy, medicine exchange, pharmacist, pharmacy deals, pharmacy chat, sell pharmacy, Dawaback, صيدلية, تبادل أدوية, صيدلي, صفقات صيدلية, دردشة صيدلية, بيع صيدلية, دواباك"
        />
      ...
      <main className="min-h-screen dark:from-background dark:via-background dark:to-background flex flex-col items-center justify-start font-sans text-foreground dark:text-foreground">
        ...
        <section className="w-full flex flex-col items-center justify-center pt-10 pb-8 px-4 text-center">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-foreground mb-4 max-w-2xl mx-auto">
            <span className="text-primary dark:text-primary">#1</span> Platform for Pharmacists to
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-8 max-w-xl mx-auto font-light">
            Dawaback connects pharmacists to exchange surplus or near-expiry medicines, chat
            directly about each deal, and even list pharmacies for sale. Secure, trusted, and built
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-4">
            ...
            <span className="flex items-center gap-2 bg-green-200 dark:bg-green-900/50 text-green-800 dark:text-green-500 px-4 py-2 rounded-full text-sm font-medium">
              ...
              >
                <path
                  d="M3 7l1.5-4h15L21 7M3 7h18v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z"
                  stroke="currentColor"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                ...
                <div className="flex flex-col md:flex-row bg-white dark:bg-card rounded-2xl shadow-md border border-primary dark:border-primary p-4 md:p-6 items-stretch gap-0 min-h-[320px] mb-1 relative">
                  ...
                  <div className="flex flex-col items-center justify-center flex-1 px-2 py-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed text-center">
                      Create your account and verify your pharmacy license with your ID and
                      Syndicate Card (front & back).
                    </p>
                  </div>
                  {/* Divider */}
                  ...
                  <div className="flex flex-col justify-center flex-1 px-2 py-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                      Ensures only licensed pharmacists join Dawaback, building a trusted and
                      professional community for safe medicine exchange.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full md:w-1/2 mt-4 md:mt-0">
                <div className="flex flex-col md:flex-row bg-white dark:bg-card rounded-2xl shadow-md border border-yellow-100 dark:border-yellow-900 p-4 md:p-6 items-stretch gap-0 min-h-[320px] mb-1 relative">
                  ...
                  <div className="flex flex-col items-center justify-center flex-1 px-2 py-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed text-center">
                      Choose a subscription plan to unlock full access to deals, chat, and pharmacy
                      listing features.
                    </p>
                  </div>
                  {/* Divider */}
                  ...
                  <div className="flex flex-col justify-center flex-1 px-2 py-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                      Subscription unlocks full access to all Dawaback features, supporting platform
                      quality and continuous improvement for pharmacists.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full md:w-1/2">
                <div className="flex flex-col md:flex-row bg-white dark:bg-card rounded-2xl shadow-md border border-purple-100 dark:border-purple-900 p-4 md:p-6 items-stretch gap-0 min-h-[320px] mb-1 relative">
                  ...
                  <div className="flex flex-col items-center justify-center flex-1 px-2 py-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed text-center">
                      Find available medicine deals or post your own offers for other pharmacists to
                      see.
                    </p>
                  </div>
                  {/* Divider */}
                  ...
                  <div className="flex flex-col justify-center flex-1 px-2 py-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                      Easily find or offer medicines, reduce waste, and help fellow pharmacists get
                      the stock they need, all in one place.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full md:w-1/2 mt-4 md:mt-0">
                <div className="flex flex-col md:flex-row bg-white dark:bg-card rounded-2xl shadow-md border border-green-100 dark:border-green-900 p-4 md:p-6 items-stretch gap-0 min-h-[320px] mb-1 relative">
                  ...
                  <div className="flex flex-col items-center justify-center flex-1 px-2 py-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed text-center">
                      Discuss details and negotiate directly with other pharmacists through secure
                      chat for each deal.
                    </p>
                  </div>
                  {/* Divider */}
                  ...
                  <div className="flex flex-col justify-center flex-1 px-2 py-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                      Direct chat for every deal makes negotiation easy, transparent, and secure—no
                      need to share personal contact info.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full md:w-1/2 mx-auto">
                <div className="flex flex-col md:flex-row bg-white dark:bg-card rounded-2xl shadow-md border border-gray-200 dark:border-gray-900 p-4 md:p-6 items-stretch gap-0 min-h-[320px] mb-1 relative">
                  ...
                  <div className="flex flex-col items-center justify-center flex-1 px-2 py-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed text-center">
                      List your pharmacy for sale and connect with interested buyers in the pharmacy
                      community.
                    </p>
                  </div>
                  {/* Divider */}
                  ...
                  <div className="flex flex-col justify-center flex-1 px-2 py-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                      Reach a network of trusted pharmacists if you ever need to sell your pharmacy,
        ...
        <section className="w-full max-w-6xl mx-auto py-20 px-4 md:px-0">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto mb-6">
              Dawaback is more than a platform—it's a secure, professional community built for
              pharmacists by pharmacists. Here’s what makes us different:
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="bg-white dark:bg-card rounded-2xl shadow border border-primary dark:border-primary p-8 flex flex-col items-center text-center hover:border-primary dark:hover:border-primary transition">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-base font-light mb-2">
                Only licensed pharmacists. No spam, no random users—just trusted professionals.
              </p>
            </div>
            {/* Feature 2 */}
            <div className="bg-white dark:bg-card rounded-2xl shadow border border-green-100 dark:border-green-900 p-8 flex flex-col items-center text-center hover:border-green-400 dark:hover:border-green-400 transition">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-base font-light mb-2">
                Your data and deals are protected. Only verified users can access deal details and
                chat.
              </p>
            </div>
            {/* Feature 3 */}
            <div className="bg-white dark:bg-card rounded-2xl shadow border border-purple-100 dark:border-purple-900 p-8 flex flex-col items-center text-center hover:border-purple-400 dark:hover:border-purple-400 transition">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-base font-light mb-2">
                Negotiate and discuss every deal instantly. No need to share your phone number or
                email.
              </p>
            </div>
            {/* Feature 4 */}
            <div className="bg-white dark:bg-card rounded-2xl shadow border border-yellow-100 dark:border-yellow-900 p-8 flex flex-col items-center text-center hover:border-yellow-400 dark:hover:border-yellow-400 transition">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-base font-light mb-2">
                List your pharmacy for sale in minutes and connect with serious, verified buyers—no
                hassle, no middlemen.
              </p>
            </div>
          </div>
        ...
        <section className="w-full max-w-4xl mx-auto py-16 px-4 md:px-0">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto mb-6">
              To ensure a trusted community, Dawaback verifies every pharmacist by matching their
              National ID and Syndicate Card. The process is simple and secure:
            </p>
          </div>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10">
            ...
            <div className="flex flex-col items-center text-center flex-1">
              ...
              <div className="min-h-[72px] flex flex-col justify-start">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  Take a clear photo of your Pharmacists Syndicate Card (front side).
                </p>
              </div>
            </div>
          </div>
          <div className="text-center mt-8">
            <p className="text-primary dark:text-primary text-base font-semibold">
              We automatically match your documents for maximum security and trust.
            </p>
          </div>
        </section>
        {/* FAQ Section */}
