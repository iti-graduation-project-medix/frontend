    ...
    <div className={"relative h-full w-full " + className}>
      ...
      {showScrollBtn && (
        <button
          ...
          className="absolute left-1/2 cursor-pointer -translate-x-1/2 bottom-4 z-20 p-2 rounded-full bg-gradient-to-br from-primary to-primary-hover text-white shadow-xl hover:scale-110 transition-all border-2 border-border backdrop-blur-lg pointer-events-auto"
