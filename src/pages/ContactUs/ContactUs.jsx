  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact Dawaback for questions, support, or partnership inquiries. We're here to help pharmacists and healthcare professionals." />
        <meta name="keywords" content="contact, Dawaback, pharmacy support, pharmacist help, healthcare contact, تواصل, دعم صيدلية, مساعدة صيدلي, تواصل صحي, دواباك" />
        <link rel="canonical" href="https://dawaback.com/contact" />
        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://dawaback.com/contact" />
        <meta property="og:title" content="Contact Us | Dawaback" />
        <meta property="og:description" content="Contact Dawaback for questions, support, or partnership inquiries. We're here to help pharmacists and healthcare professionals." />
        <meta property="og:image" content="https://dawaback.com/og-image.jpg" />
        <meta property="og:site_name" content="Dawaback" />
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://dawaback.com/contact" />
      ...
      >
        <div className="container mx-auto px-4 py-16 max-w-7xl">
          ...
          >
            ...
            <motion.p
              className="text-muted-foreground dark:text-muted-foreground max-w-2xl mx-auto text-lg"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            <motion.div className="h-full" variants={itemAnimation}>
              <Card className="py-3 px-4 overflow-hidden shadow-2xl border-0 rounded-3xl bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-background dark:via-card dark:to-background text-card-foreground dark:text-card-foreground relative w-full max-w-2xl mx-auto px-4 py-6 sm:px-6 md:px-8 lg:px-10 xl:px-12">
                {/* Decorative Elements */}
                <div
                ...
                <CardHeader>
                  ...
                  >
                    <CardTitle className="text-xl md:text-2xl text-primary dark:text-primary">
                      Get in Touch
                    </CardTitle>
                            ...
                            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                              ...
                              >
                                <path
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                                  d="M7 7h.01M3 11l7.293-7.293a1 1 0 011.414 0l7.293 7.293a1 1 0 010 1.414l-7.293 7.293a1 1 0 01-1.414 0L3 12.414a1 1 0 010-1.414z"
                                />
                              </svg>
                            </span>
                            <Field
